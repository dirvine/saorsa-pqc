...
pub trait SignatureScheme {
    ...
    /// Verify a signature
    fn verify(pk: &Self::PublicKey, message: &[u8], signature: &Self::Signature) -> PqcResult<bool>;
...
mod tests {
    ...
    impl Kem for MockKem {
        ...
        fn decapsulate(_sk: &Self::SecretKey, _ct: &Self::Ciphertext) -> PqcResult<Self::SharedSecret> {
            Ok(MockSs([0; 32]))
        }
